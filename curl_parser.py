...
một mẫu curl giả lập (xem tests/test_parsing.py); nếu format curl thật
của bạn khác biệt (vd copy từ Firefox, hoặc từ PowerShell/cmd trên
Windows), có thể cần chỉnh lại _parse_headers_and_cookie bên dưới.
"""
